  ...
  <div class="app-container">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width>
          ...
          <el-form-item label="退款原因：">
            <el-select v-model="listQuery.reasonId" class="input-width" placeholder="全部" clearable>
              <el-option
    ...
    <div class="table-container">
      ...
      >
        ...
        <el-table-column label="积分兑换金额" align="center">
        ...
        <el-table-column label="操作" width="200" align="center">
          <template slot-scope="scope">
            <el-button size="mini" type="text" @click="handleUpdate(scope.$index, scope.row)">退款审核</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
...
<script>
import { fetchList, fetchReason } from "@/api/otoApply";
...
export default {
  ...
  created() {
    this.getList();
    this.getListRefundReasonOption();
  },
  filters: {
  ...
  methods: {
    ...
    //退款原因查询
    getListRefundReasonOption() {
      fetchReason(this.listQuery).then(response => {
        this.orderTypeOptions = response.data.list;
      });
    },
    getList() {
